...
const medicineDatabase = {
    ...
    dexchlorpheniramine: {
        ...
        function: "Mengatasi alergi seperti rinitis alergi dan urtikaria.",
        dosage: "2 mg setiap 4-6 jam.",
        usage: "Diminum setelah makan.",
        contraindications: "Glaukoma sudut sempit.",
        forms: "Tablet, Sirup."
    },
    bromhexine: {
        name: "Bromhexine",
        function: "Mengencerkan dahak pada saluran pernapasan.",
        dosage: "8 mg tiga kali sehari.",
        usage: "Diminum setelah makan.",
        contraindications: "Hipersensitivitas terhadap bromhexine.",
        forms: "Tablet, Sirup."
    },
    ambroxol: {
        name: "Ambroxol",
        function: "Mengencerkan dahak pada gangguan saluran pernapasan.",
        dosage: "30 mg tiga kali sehari.",
        usage: "Diminum setelah makan.",
        contraindications: "Hipersensitivitas terhadap ambroxol.",
        forms: "Tablet, Sirup."
    },
    ranitidine: {
        name: "Ranitidine",
        ...
        dosage: "150 mg dua kali sehari.",
        usage: "Diminum sebelum makan.",
        contraindications: "Alergi terhadap ranitidine.",
        forms: "Tablet, Sirup."
    },
    erythromycin: {
        name: "Erythromycin",
        function: "Mengobati infeksi bakteri.",
        dosage: "250-500 mg setiap 6 jam.",
        usage: "Diminum sebelum atau setelah makan.",
        contraindications: "Disfungsi hati berat.",
        forms: "Tablet, Sirup."
    },
    clarithromycin: {
        name: "Clarithromycin",
        function: "Mengobati infeksi bakteri saluran pernapasan.",
        dosage: "250-500 mg dua kali sehari.",
        usage: "Diminum sebelum atau setelah makan.",
        contraindications: "Gangguan hati berat.",
        forms: "Tablet, Sirup."
    ...
    lorazepam: {
        name: "Lorazepam",
        function: "Mengatasi kecemasan dan insomnia.",
        dosage: "1-3 mg per hari dalam dosis terbagi.",
        usage: "Diminum sesuai resep dokter.",
        contraindications: "Myasthenia gravis.",
        forms: "Tablet."
    },
    domperidone: {
        name: "Domperidone",
        function: "Meredakan mual dan muntah.",
        dosage: "10 mg tiga kali sehari.",
        usage: "Diminum sebelum makan.",
        contraindications: "Gangguan hati berat.",
        forms: "Tablet, Sirup."
    ...
    ondansetron: {
        name: "Ondansetron",
        function: "Meredakan mual dan muntah akibat kemoterapi.",
        dosage: "4-8 mg dua hingga tiga kali sehari.",
        usage: "Diminum sebelum makan.",
        contraindications: "Hipersensitivitas terhadap ondansetron.",
        forms: "Tablet, Injeksi."
    },
    tramadol: {
        name: "Tramadol",
        ...
        dosage: "50-100 mg setiap 4-6 jam.",
        usage: "Diminum sesuai resep dokter.",
        contraindications: "Gangguan pernapasan akut.",
        forms: "Tablet, Kapsul."
    },
    ketorolac: {
        name: "Ketorolac",
        function: "Meredakan nyeri akut.",
        dosage: "10 mg setiap 4-6 jam.",
        usage: "Diminum setelah makan.",
        contraindications: "Ulkus lambung aktif.",
        forms: "Tablet, Injeksi."
    },
    chlorpheniramine: {
        ...
        function: "Meredakan gejala alergi.",
        dosage: "4 mg setiap 4-6 jam.",
        usage: "Diminum setelah makan.",
        contraindications: "Glaukoma sudut sempit.",
        forms: "Tablet, Sirup."
    },
    ...
    loratadine: {
        name: "Loratadine",
        function: "Mengatasi gejala alergi seperti gatal dan bersin.",
        dosage: "10 mg sekali sehari.",
        usage: "Diminum kapan saja.",
        contraindications: "Kehamilan dan menyusui.",
        forms: "Tablet, Sirup."
    ...
    spironolactone: {
        name: "Spironolactone",
        function: "Mengobati hipertensi dan edema.",
        dosage: "25-100 mg sekali sehari.",
        usage: "Diminum kapan saja.",
        contraindications: "Hiperkalemia.",
        forms: "Tablet."
    ...
    diltiazem: {
        name: "Diltiazem",
        function: "Mengobati hipertensi dan angina.",
        dosage: "120-360 mg sekali atau dua kali sehari.",
        usage: "Diminum kapan saja.",
        contraindications: "Blok jantung derajat 2 atau 3.",
        forms: "Tablet."
    ...
    furosemide: {
        name: "Furosemide",
        function: "Mengatasi retensi cairan.",
        dosage: "20-80 mg sekali sehari.",
        usage: "Diminum pagi hari.",
        contraindications: "Dehidrasi berat.",
        forms: "Tablet, Injeksi."
    ...
    propranolol: {
        name: "Propranolol",
        function: "Mengobati hipertensi dan migrain.",
        dosage: "40-320 mg per hari.",
        usage: "Diminum kapan saja.",
        contraindications: "Asma berat.",
        forms: "Tablet."
    },
    verapamil: {
        name: "Verapamil",
        function: "Mengobati hipertensi dan aritmia.",
        dosage: "120-360 mg sehari.",
        usage: "Diminum kapan saja.",
        contraindications: "Blok jantung derajat 2 atau 3.",
        forms: "Tablet, Injeksi."
    },
    ...
    antasida: {
        name: "Antasida",
        function: "Mengurangi gejala sakit maag dengan menetralkan asam lambung.",
        dosage: "1-2 tablet dikunyah sesuai kebutuhan, maksimal 3 kali sehari.",
        usage: "Setelah makan.",
    ...
    panadol: {
        name: "Panadol",
        function: "Meredakan nyeri ringan hingga sedang dan menurunkan demam.",
        dosage: "500-1000 mg setiap 4-6 jam, maksimal 4 gram sehari.",
        usage: "Diminum setelah makan.",
        contraindications: "Gangguan hati berat.",
        forms: "Tablet."
    },
    promagh: {
        name: "Promagh",
        function: "Mengatasi gangguan lambung seperti maag dan gastritis.",
        dosage: "1 sachet atau tablet 2-3 kali sehari.",
        usage: "Sebelum atau setelah makan.",
        contraindications: "Hipersensitivitas terhadap komponen obat.",
        forms: "Tablet, Cairan."
    }
